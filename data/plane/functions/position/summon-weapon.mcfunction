...
scoreboard players set #return vp.reg1 0
#魚雷を装備しているかストレージ確認
execute store success score #has-torpedo vp.reg1 if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].weapon.weapon-list[].data{type:torpedo}
