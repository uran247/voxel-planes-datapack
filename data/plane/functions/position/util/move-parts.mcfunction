...
#座標取得
execute store result score #current-x vp.reg1 run data get entity @s Pos[0] 1000
execute store result score #current-y vp.reg1 run data get entity @s Pos[1] 1000
execute store result score #current-z vp.reg1 run data get entity @s Pos[2] 1000
