...
#座標取得エンティティtp
execute at @s rotated ~-90 ~ positioned ^1 ^ ^ run tp 0-0-0-0-1 ~ ~ ~
execute at @s rotated ~-90 ~ positioned ^ ^1 ^ run tp 0-0-0-0-2 ~ ~ ~
execute at @s rotated ~-90 ~ positioned ^ ^ ^1 run tp 0-0-0-0-3 ~ ~ ~
