...
execute unless score #weapon-number vp.reg1 matches 1.. run data modify storage plane-datapack plane-info append value '{"text":""}'
...
execute unless score #weapon-number vp.reg1 matches 2.. run data modify storage plane-datapack plane-info append value '{"text":""}'
...
execute unless score #weapon-number vp.reg1 matches 3.. run data modify storage plane-datapack plane-info append value '{"text":""}'
...
execute unless score #weapon-number vp.reg1 matches 4.. run data modify storage plane-datapack plane-info append value '{"text":""}'
...
execute unless score #weapon-number vp.reg1 matches 5.. run data modify storage plane-datapack plane-info append value '{"text":""}'
