...
execute unless data entity @s Inventory[{Slot:-106b,components:{"minecraft:custom_data":{item-type:controll-rod}}}] run item replace block 0 1 0 container.4 from entity @s weapon.offhand
...
execute unless data entity @s Inventory[{Slot:7b,components:{"minecraft:custom_data":{item-type:indicator}}}] run item replace block 0 1 0 container.7 from entity @s hotbar.7
...
execute unless data entity @s Inventory[{Slot:7b,components:{"minecraft:custom_data":{item-type:indicator}}}] run loot replace entity @s hotbar.7 loot item:dummy/lock-turning
...
execute unless data entity @s Inventory[{Slot:-106b,components:{"minecraft:custom_data":{item-type:controll-rod}}}] run loot replace entity @s weapon.offhand loot item:tools/controll-stick
