...
#飛行機情報表示
title @p[tag=controller] actionbar ["",{"nbt":"plane-info[0]","storage":"plane-datapack","interpret":true},{"text":" Throt:","color":"red"},{"score":{"name":"#throttle","objective":"reg1"},"color":"red"},{"text":"% Alt:","color":"red"},{"score":{"name":"#altitude","objective":"reg1"},"color":"red"},{"text":" Wpn:","color":"yellow"},{"nbt":"plane-datapack plane-info[6]","storage":"plane-datapack","color":"yellow"},{"text":" Ammo:{","color":"green"},{"nbt":"plane-info[1]","storage":"plane-datapack","color":"green","interpret":true},{"nbt":"plane-info[2]","storage":"plane-datapack","color":"green","interpret":true},{"nbt":"plane-info[3]","storage":"plane-datapack","color":"green","interpret":true},{"nbt":"plane-info[4]","storage":"plane-datapack","color":"green","interpret":true},{"text":"}","color":"green"}]
