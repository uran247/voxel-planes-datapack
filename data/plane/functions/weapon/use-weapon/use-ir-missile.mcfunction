...
execute as @e[tag=use-init,distance=..1,limit=1] at @s run function plane:position/calc-offset
execute as @e[tag=use-init,distance=..1,limit=1] at @s run function plane:position/util/move-parts
