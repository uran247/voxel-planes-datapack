...
#飛行機データセット
data modify storage voxel-planes:plane a6m5.plane-data.name set value a6m5
...
data modify storage voxel-planes:plane a6m5.plane-data.model-data.translation set value [0f,-0.5f,0.8f]
data modify storage voxel-planes:plane a6m5.plane-data.model-data.central-axis-offset set value 1.375
data modify storage voxel-planes:plane a6m5.plane-data.seat.position.ridden set value {x:0,y:0,z:-4}
data modify storage voxel-planes:plane a6m5.plane-data.seat.position.vacant set value {x:0,y:-0.5,z:0.5}
