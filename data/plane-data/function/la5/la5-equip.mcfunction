...
#装備品チェック
execute store success score #60kg-bomb vp.reg1 if entity @e[type=minecraft:donkey,tag=target-parts,nbt={Items:[{components:{"minecraft:custom_data":{item-type:60kg-bomb}}}]},distance=..30]
