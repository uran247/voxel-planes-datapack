...
data modify storage voxel-planes:plane bf109g.plane-data.seat.position.ridden set value {x:0,y:0,z:-4.6}
data modify storage voxel-planes:plane bf109g.plane-data.seat.position.vacant set value {x:0,y:-0.4,z:-0.6}
