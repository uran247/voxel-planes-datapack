...
execute as @s[tag=500kg] as @e[distance=..10,tag=plane-parts-target,scores={accelerate-cor=..-1}] run scoreboard players add @s accelerate-cor 2
execute as @s[tag=500kg] as @e[distance=..10,tag=plane-parts-target,scores={pitch-speed-cor=..-1}] run scoreboard players add @s pitch-speed-cor 4
execute as @s[tag=500kg] as @e[distance=..10,tag=plane-parts-target,scores={yaw-speed-cor=..-1}] run scoreboard players add @s yaw-speed-cor 4
...
execute as @s[tag=250kg] if score #offset reg1 matches 0 run summon armor_stand ^-0.5 ^-1 ^ {Tags:["ki49-bomb",drop-init,dropping,plane-bomb,plane-parts,entity-nohit,250kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:77,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
execute as @s[tag=250kg] if score #offset reg1 matches 1 run summon armor_stand ^0.5 ^-1 ^ {Tags:["ki49-bomb",drop-init,dropping,plane-bomb,plane-parts,entity-nohit,250kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:77,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
scoreboard players set @e[tag=ki49-bomb,tag=drop-init,tag=250kg] damage 1250

execute as @s[tag=500kg] run summon armor_stand ^ ^-1 ^ {Tags:["ki49-bomb",drop-init,dropping,plane-bomb,plane-parts,entity-nohit,500kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:118,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
scoreboard players set @e[tag=ki49-torpedo,tag=drop-init,tag=torpedo] torp-damage 2500
