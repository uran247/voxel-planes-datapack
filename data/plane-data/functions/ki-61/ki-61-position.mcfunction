...
execute as @s[tag=bombed,scores={vp.reg1=0}] if score @s vp.ammunition3 = @s vp.max-ammo3 at @s store success score #summoned-bomb vp.reg1 run function plane-data:ki-61/summon/ki61-bomb
