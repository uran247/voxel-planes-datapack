...
execute unless entity @s[tag=mg151] run scoreboard players set @e[tag=gun-init,distance=..5] damage 18
execute if entity @s[tag=mg151] run scoreboard players set @e[tag=gun-init,distance=..5] damage 27
...
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetX 2200
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetY -180
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetZ 2200
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetX -2280
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetY -180
