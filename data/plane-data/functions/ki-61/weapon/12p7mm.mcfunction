#> plane-data:ki-61/weapon/12p7mm
#
# 20mm機銃を使用
#
# @input
...
scoreboard players set @e[tag=gun-init,tag=left1,distance=..5] vp.offsetX 140
scoreboard players set @e[tag=gun-init,tag=left1,distance=..5] vp.offsetY 630
scoreboard players set @e[tag=gun-init,tag=left1,distance=..5] vp.offsetZ 2200
scoreboard players set @e[tag=gun-init,tag=right1,distance=..5] vp.offsetX -190
scoreboard players set @e[tag=gun-init,tag=right1,distance=..5] vp.offsetY 630
