...
scoreboard players set @e[tag=gun-init,distance=..5] damage 9
...
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetX 140
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetY 630
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetZ 2200
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetX -190
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetY 630
