...
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetX 210
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetY 720
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetZ 0
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] vp.offsetX -210
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] vp.offsetY 720
