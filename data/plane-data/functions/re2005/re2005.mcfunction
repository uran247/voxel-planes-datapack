...
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:110f,Attributes:[{Name:"generic.max_health",Base:110}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:100f,Attributes:[{Name:"generic.max_health",Base:100}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:90f,Attributes:[{Name:"generic.max_health",Base:90}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:90f,Attributes:[{Name:"generic.max_health",Base:90}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:70f,Attributes:[{Name:"generic.max_health",Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:70f,Attributes:[{Name:"generic.max_health",Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:70f,Attributes:[{Name:"generic.max_health",Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["re2005-hitbox","re2005",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"cockpit\"}",Health:120f,Attributes:[{Name:"generic.max_health",Base:120}]}
...
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.max-ammo1 225
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.max-ammo-rel1 280
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.w2-reload 0
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.ammunition2 2
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.max-ammo2 2
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.max-ammo-rel2 3600
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.plane-weapon 1
scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.weapon-types 2

scoreboard players set @e[tag=plane-init,tag=re2005-root] vp.max-engine 1

execute store result score @e[tag=plane-init,tag=re2005-root,limit=1] vp.PosX run data get entity @e[tag=plane-init,tag=re2005-root,limit=1] Pos[0] 10000
execute store result score @e[tag=plane-init,tag=re2005-root,limit=1] vp.PosY run data get entity @e[tag=plane-init,tag=re2005-root,limit=1] Pos[1] 10000
execute store result score @e[tag=plane-init,tag=re2005-root,limit=1] vp.PosZ run data get entity @e[tag=plane-init,tag=re2005-root,limit=1] Pos[2] 10000
