...
#召喚
execute if score #is-tracer vp.reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,Tags:[projectile,gun,7p7mm,gun-init,right,tracer-lightblue,tracer,entity-nohit,offset-base],Duration:25}
execute if score #is-tracer vp.reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,Tags:[projectile,gun,7p7mm,gun-init,left,tracer-lightblue,tracer,entity-nohit,offset-base],Duration:25}
execute unless score #is-tracer vp.reg1 matches 0 run summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,7p7mm,gun-init,right,tracer-lightblue,entity-nohit,offset-base],Duration:25}
execute unless score #is-tracer vp.reg1 matches 0 run summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,7p7mm,gun-init,left,tracer-lightblue,entity-nohit,offset-base],Duration:25}
...
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetX 110
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetY -1850
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] vp.offsetZ -6100
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] vp.offsetX -400
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] vp.offsetY -1850
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] vp.offsetZ -6100
