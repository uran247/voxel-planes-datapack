...
execute as @e[tag=d4y2-rocket-right1,tag=d4y2-init] store result entity @s Attributes[{Name:"minecraft:generic.movement_speed"}].Base double 1 run scoreboard players get @s plane-id
...
execute as @e[tag=d4y2-rocket-left1,tag=d4y2-init] store result entity @s Attributes[{Name:"minecraft:generic.movement_speed"}].Base double 1 run scoreboard players get @s plane-id
...
execute as @e[tag=d4y2-rocket-right2,tag=d4y2-init] store result entity @s Attributes[{Name:"minecraft:generic.movement_speed"}].Base double 1 run scoreboard players get @s plane-id
...
execute as @e[tag=d4y2-rocket-left2,tag=d4y2-init] store result entity @s Attributes[{Name:"minecraft:generic.movement_speed"}].Base double 1 run scoreboard players get @s plane-id
