...
execute if score #rocket vp.reg1 matches 1.. run data remove storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].weapon.weapon-list[{data:{type:bomb}}].data.bombs[{weight:60kg}]
...
execute unless score #rocket vp.reg1 matches 1.. if entity @e[tag=target-parts,tag=plane-rocket,tag=normal] run kill @e[tag=target-parts,tag=plane-rocket]
execute if score #rocket vp.reg1 matches 1.. if entity @e[tag=target-parts,tag=60kg,tag=normal] run kill @e[tag=target-parts,tag=plane-bomb]
