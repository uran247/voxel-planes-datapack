...
execute if entity @p[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=1,w1-reload=..0,ammunition1=1..}] at @s run function plane-data:d4y2/weapon/7p7mm
execute if entity @p[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=2,w2-reload=..0,ammunition2=1..},tag=flying] at @s run function plane-data:d4y2/weapon/bomb
...
execute if entity @p[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=3,w4-reload=..0,ammunition4=1..}] at @s run function plane-data:d4y2/weapon/rocket
...
#後部機銃発射（自動発射）
execute if entity @s[scores={w3-reload=..0,ammunition3=1..}] at @s run function plane-data:d4y2/weapon/check-rear-target
execute if entity @s[scores={w3-reload=..0,ammunition3=1..}] if entity @e[tag=rear-gun-target,distance=..32] at @s run function plane-data:d4y2/weapon/rear-gun
