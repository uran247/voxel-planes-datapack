...
#装備
execute if score #1000lb vp.reg1 matches 1.. run tag @s add bombed
...
scoreboard players operation @s[tag=rocketted] vp.ammunition3 = @s vp.max-ammo3
scoreboard players set @s[tag=!rocketted] vp.ammunition3 0
