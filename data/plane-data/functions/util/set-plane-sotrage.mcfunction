...
execute if data storage voxel-planes:input input.hitbox.engine-r2 run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].status.engine-r2.hp set from storage voxel-planes:input input.hitbox.engine-r2.max-hp
execute if data storage voxel-planes:input input.hitbox.engine-l2 run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].status.engine-l2.hp set from storage voxel-planes:input input.hitbox.engine-l2.max-hp
...
execute if data storage voxel-planes:input input.hitbox.aileron-r2 run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].status.aileron-r2.hp set from storage voxel-planes:input input.hitbox.aileron-r2.max-hp
execute if data storage voxel-planes:input input.hitbox.aileron-l2 run data modify storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].status.aileron-l2.hp set from storage voxel-planes:input input.hitbox.aileron-l2.max-hp
