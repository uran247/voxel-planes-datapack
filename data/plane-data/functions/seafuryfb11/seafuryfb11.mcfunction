...
summon item_display ~ ~ ~ {Tags:["plane-body","seafuryfb11",plane-init,plane,has-model,model-changeable,entity-nohit],NoGravity:1b,item:{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:125,Unbreakable:1b}},interpolation_duration:1,view_range:4.0f,transformation:{right_rotation:{angle:3.1416f,axis:[0f,1f,0f]},left_rotation:{angle:0f,axis:[0f,0f,1f]},scale:[1f,1f,1f],translation:[1f,1.5f,0f]},item_display:"thirdperson_righthand"}
