#> plane-data:g4m1/weapon/check-rear4-target
#
# @input
...
execute as 0-0-0-0-4 run scoreboard players set @s vp.offsetZ -8200
...
execute as 0-0-0-0-a run scoreboard players set @s vp.offsetZ -9200
