#> plane-data:ki-21/weapon/check-rear2-target
#
# @input
...
execute as 0-0-0-0-4 run scoreboard players set @s vp.offsetY -18090
execute as 0-0-0-0-4 run scoreboard players set @s vp.offsetZ 27712
