...
execute as @s[tag=50kg,tag=bombed,scores={ammunition1=20,reg1=0}] store success score #summoned reg1 run function plane-data:ki-21/summon/ki-21-50kg-bomb
execute as @s[tag=250kg,tag=bombed,scores={ammunition1=4,reg1=0}] store success score #summoned reg1 run function plane-data:ki-21/summon/ki-21-250kg-bomb
