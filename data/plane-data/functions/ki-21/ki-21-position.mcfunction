...
execute as @s[tag=50kg,tag=has-bomb,scores={vp.ammunition1=20,vp.reg1=0}] store success score #summoned vp.reg1 run function plane-data:ki-21/summon/ki-21-50kg-bomb
execute as @s[tag=250kg,tag=has-bomb,scores={vp.ammunition1=4,vp.reg1=0}] store success score #summoned vp.reg1 run function plane-data:ki-21/summon/ki-21-250kg-bomb
