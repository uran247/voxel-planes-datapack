...
#選択に応じて武器ファンクション実行
execute if entity @p[tag=weapon-user,scores={vp.rightClick=1..}] if entity @s[tag=flying,scores={vp.curr-weapon=1,vp.w1-cooltime=..0,vp.ammunition1=1..,vp.AngX=..1600,vp.AngZ=-1000..1000}] at @s run function plane-data:ki-21/weapon/bomb
