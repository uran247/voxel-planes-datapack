...
scoreboard players set @e[tag=plane-init,tag=a6m5-root] vp.w1-cooltime 0
scoreboard players set @e[tag=plane-init,tag=a6m5-root] vp.w2-cooltime 0
...
scoreboard players set @e[tag=plane-init,tag=a6m5-root] vp.max-w1-reload 280
scoreboard players set @e[tag=plane-init,tag=a6m5-root] vp.max-w2-reload 140
scoreboard players set @e[tag=plane-init,tag=a6m5-root] vp.max-w3-reload 3000
