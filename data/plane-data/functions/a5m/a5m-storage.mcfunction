...
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {engine:{size:1,max-hp:50d,offset:[0d,-0.7d,2.7d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {aileron-r:{size:1,max-hp:50d,offset:[-3d,-0.9d,1.4d]},aileron-l:{size:1,max-hp:50d,offset:[3d,-0.9d,1.4d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {elevator-r:{size:1,max-hp:50d,offset:[-0.9d,-0.6d,-3.1d]},elevator-l:{size:1,max-hp:50d,offset:[0.9d,-0.6d,-3.1d]}}
...
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {body:{size:1,max-hp:50d,offset:[0d,-0.5d,1d]}}
