...
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {engine:{offset:[0d,-0.2d,2.7d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {aileron-r:{offset:[-3d,-0.4d,1.4d]},aileron-l:{offset:[3d,-0.4d,1.4d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {elevator-r:{offset:[-0.9d,-0.3d,-3.1d]},elevator-l:{offset:[0.9d,-0.3d,-3.1d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {radder:{offset:[0d,0.5d,-3.5d]}}
data modify storage voxel-planes:plane a5m.plane-data.hitbox merge value {cockpit:{offset:[0d,0.5d,1.3d]}}
