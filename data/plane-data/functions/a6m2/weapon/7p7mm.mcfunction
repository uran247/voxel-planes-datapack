...
#
# @within function plane-data:a6m2/a6m2-weapon-manager
...
scoreboard players set @e[type=armor_stand,tag=gun-init] vp.max-age 25
scoreboard players operation @e[tag=gun-init] vp.plane-id = @s vp.plane-id
scoreboard players set @e[tag=gun-init,tag=left1] vp.offsetX 220
scoreboard players set @e[tag=gun-init,tag=left1] vp.offsetY 550
scoreboard players set @e[tag=gun-init,tag=left1] vp.offsetZ 2500
scoreboard players set @e[tag=gun-init,tag=right1] vp.offsetX -260
scoreboard players set @e[tag=gun-init,tag=right1] vp.offsetY 550
scoreboard players set @e[tag=gun-init,tag=right1] vp.offsetZ 2500
