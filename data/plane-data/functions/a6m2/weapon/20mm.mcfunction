...
execute if score #is-bullet vp.reg1 matches 0 unless score #is-tracer vp.reg1 matches 0 run summon area_effect_cloud ~ ~ ~ {Tags:[projectile,gun,20mm,gun-init,right1,tracer,tracer-yellow,entity-nohit,offset-base],Duration:30}
execute if score #is-bullet vp.reg1 matches 0 unless score #is-tracer vp.reg1 matches 0 run summon area_effect_cloud ~ ~ ~ {Tags:[projectile,gun,20mm,gun-init,left1,tracer,tracer-yellow,entity-nohit,offset-base],Duration:30}
...
scoreboard players set @e[tag=gun-init,tag=left1,distance=..5] vp.offsetX 1950
...
scoreboard players set @e[tag=gun-init,tag=right1,distance=..5] vp.offsetX -2050
