...
execute if score #summoned-bomb vp.reg1 matches 1.. as @e[tag=a6m2,tag=plane-bomb,tag=!dropping,distance=..10] if score @s vp.plane-id = #plane-id vp.reg1 run tag @s add target-parts
