...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,NoGravity:0b,Tags:[a6m2-root,a6m2,plane-init,plane-root,plane,entity-nohit,need-calc-offset,delay-rotation,has-weapon1,has-weapon2,main-weapon1,main-weapon2,main-weapon3,tier2],CustomName:'{"text":"a6m2"}',Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,HandItems:[{id:"snowball",Count:1b,tag:{CustomModelData:1,weapons:["20mm gun","7.7mm gun","bomb"]}},{}]}
summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,NoGravity:0b,Tags:[a6m2,plane-init,plane,entity-nohit,plane-seat],CustomName:'{"text":"seat"}',Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},Passengers:[{id:"donkey",Health:12f,Attributes:[{Name:"generic.max_health",Base:12d}],Invulnerable:1b,DeathLootTable:"minecraft:entities/bat",SaddleItem:{id:"minecraft:saddle",Count:1b},Tame:1b,NoAI:1b,Silent:1b,ChestedHorse:1b,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],Tags:[a6m2,plane-init,plane,plane-seat,entity-nohit]}],DisabledSlots:256}
summon armor_stand ~ ~ ~ {Tags:["a6m2-body","a6m2",plane-init,plane,has-model,model-changeable,entity-nohit],NoGravity:1b,Invisible:1b,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:87,Unbreakable:1b}},{}],Pose:{LeftArm:[0f,0f,0f],RightArm:[-12f,0f,0f]},DisabledSlots:256}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"body"}',Health:110f,Attributes:[{Name:"generic.max_health",Base:110d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"engine"}',Health:100f,Attributes:[{Name:"generic.max_health",Base:100d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"aileron-right"}',Health:90f,Attributes:[{Name:"generic.max_health",Base:90d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"aileron-left"}',Health:90f,Attributes:[{Name:"generic.max_health",Base:90d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"elevator-right"}',Health:70f,Attributes:[{Name:"generic.max_health",Base:70d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"elevator-left"}',Health:70f,Attributes:[{Name:"generic.max_health",Base:70d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"radder"}',Health:70f,Attributes:[{Name:"generic.max_health",Base:70d}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1b,Marker:1b,Glowing:0b,CustomName:'{"text":"cockpit"}',Health:120f,Attributes:[{Name:"generic.max_health",Base:120d}]}
...
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.accelerate 49
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.resistance 28
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.energy-loss 6
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.deaccelerate 64
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.max-speed 18500
...
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.gear-ret-min 5100
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.gear-ret-max 5300
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.gear-po-min 4800
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.gear-po-max 5000

scoreboard players set @e[tag=plane-init,tag=plane-root] vp.landing-pitch -1100
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.AngX -1100
...
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.pitch-speed 200
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.yaw-speed 200
...
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.ammunition1 60
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.ammunition2 700
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.ammunition3 0
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.max-ammo1 60
scoreboard players set @e[tag=plane-init,tag=plane-root] vp.max-ammo2 700
