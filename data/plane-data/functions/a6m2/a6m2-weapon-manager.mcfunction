...
execute if entity @p[tag=weapon-user,scores={vp.rightClick=1..}] if entity @s[scores={vp.plane-weapon=3,vp.w3-reload=..0,vp.ammunition3=1..}] at @s run function plane-data:a6m2/weapon/bomb
