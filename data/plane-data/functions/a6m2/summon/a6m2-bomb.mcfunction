#> plane-data:a6m2/summon/a6m2-bomb
#
# 爆弾召喚
#
# @input
...
#
# @within plane-data:a6m2/a6m2-position
...
#### 60kg爆弾2個目召喚 ####
execute if entity @s[tag=60kg] run summon armor_stand ~ ~ ~ {Tags:[a6m2-bomb-left,"a6m2",weapon-init,plane,has-offset,has-model,plane-bomb,plane-parts,entity-nohit,60kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{CustomModelData:76,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
scoreboard players set @e[tag=weapon-init] vp.offsetX 3100
scoreboard players set @e[tag=weapon-init] vp.offsetY -600
scoreboard players set @e[tag=weapon-init] vp.offsetZ 1000
scoreboard players set @e[tag=weapon-init] vp.damage 300
