...
scoreboard players set @e[tag=plane-init,tag=n1k2-root] vp.w1-cooltime 0
...
scoreboard players set @e[tag=plane-init,tag=n1k2-root] vp.max-w1-reload 280
scoreboard players set @e[tag=plane-init,tag=n1k2-root] vp.w2-cooltime 0
...
scoreboard players set @e[tag=plane-init,tag=n1k2-root] vp.max-w2-reload 3600
...
data modify storage minecraft:plane-datapack temporary.Pos set from entity @e[tag=plane-init,tag=n1k2-root,limit=1] Pos
execute store result score @e[tag=plane-init,tag=n1k2-root,limit=1] vp.PosX run data get storage minecraft:plane-datapack temporary.Pos[0] 10000
execute store result score @e[tag=plane-init,tag=n1k2-root,limit=1] vp.PosY run data get storage minecraft:plane-datapack temporary.Pos[1] 10000
execute store result score @e[tag=plane-init,tag=n1k2-root,limit=1] vp.PosZ run data get storage minecraft:plane-datapack temporary.Pos[2] 10000
