...
#
# @within function plane-data:n1k2/n1k2-weapon-manager
...
# @private
    ...
    #declare tag left2 #左側2番目の機銃弾であることを示す
    #declare tag right2 #右側2番目の機銃弾であることを示す
    #
...
execute if score #is-tracer vp.reg1 matches 0 run summon armor_stand ~ ~ ~ {NoGravity:1b,Invisible:1b,Tags:[projectile,gun,20mm,gun-init,right2,tracer-orange,entity-nohit,offset-base,tracer]}
...
execute if score #is-tracer vp.reg1 matches 0 run summon armor_stand ~ ~ ~ {NoGravity:1b,Invisible:1b,Tags:[projectile,gun,20mm,gun-init,left2,tracer-orange,entity-nohit,offset-base,tracer]}
