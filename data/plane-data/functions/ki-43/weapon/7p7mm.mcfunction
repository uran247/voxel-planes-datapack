...
#召喚
execute if score #is-tracer vp.reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,7p7mm,gun-init,right,tracer,tracer-lightblue,entity-nohit,offset-base],Invisible:1,Pose:{Head:[0.01f,0f,0f]}}
execute if score #is-tracer vp.reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,7p7mm,gun-init,left,tracer,tracer-lightblue,entity-nohit,offset-base],Invisible:1,Pose:{Head:[0.01f,0f,0f]}}
