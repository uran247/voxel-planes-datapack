...
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["a6m-hitbox","a6m",a6m-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:80f,Attributes:[{Name:"generic.max_health",Base:80}]}

#ID付与
execute as @e[tag=a6m-init,tag=a6m-root,limit=1] store result score @s vp.plane-id run data get entity @s UUID[0]
scoreboard players operation @e[tag=a6m-init,tag=a6m-root,limit=1,scores={vp.plane-id=..-1}] vp.plane-id *= #-1 vp.Num
scoreboard players operation @e[tag=a6m-init] vp.plane-id = @e[tag=a6m-init,tag=a6m-root,limit=1] vp.plane-id
execute as @e[tag=a6m-init] store result entity @s Attributes[{Name:"minecraft:generic.movement_speed"}].Base double 1 run scoreboard players get @s vp.plane-id
...
scoreboard players set @e[tag=a6m-init,tag=a6m-root] vp.w1-reload 0
scoreboard players set @e[tag=a6m-init,tag=a6m-root] vp.w2-reload 0
...
scoreboard players set @e[tag=a6m-init,tag=a6m-root] vp.plane-weapon 1
