...
execute if data storage voxel-planes:return sun-rotation positioned 0.0 0.0 0.0 rotated as @e[tag=dummy-sun,limit=1] run tp @e[tag=dummy-sun,distance=..0.01,limit=1] ^ ^ ^16
