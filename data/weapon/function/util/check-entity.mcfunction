...
tp 0-0-0-0-b ~ ~ ~
$execute positioned ^ ^ ^$(range) as @e[tag=!check-executer,tag=!entity-nohit,distance=..$(range)] positioned as @s positioned ^ ^ ^1000 facing entity 0-0-0-0-b feet positioned ^ ^ ^1000 positioned ~-0.5 ~-0.5 ~-0.5 if entity @s[dx=0,dy=0,dz=0] run tag @s add hit-on-line
